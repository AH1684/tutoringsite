...
(defmethod display-main ((page info-page) status)
  (with-html
    ...
    (:p "Email or text me at: " (:i "a.horncompmail@gmail.com"))
    (:h5 "What does a session cost?")
    (:ul (:li "$50 per hour, $40 if scheduled for 3 or more hrs a week.")
    ...
    (:p "I can work in the evenings or weekends as necessary.")
    (:h5 "How early should I schedule a meeting?")
    (:p "At least 24 hours before you want to meet. During midterms or finals, I suggest scheduling the week before.")
...
(defclass reviews (primary-layout)
  ())

(defmethod display-main ((page reviews) status)
  (with-html
      (:a :href "https://www.facebook.com/profile.php?id=100090330890215&sk=reviews" "Leave me a review here!")
    ))
